...
func (tx *Tx) init() {
	...
	tx.ImageConversation = NewImageConversationClient(tx.config)
	tx.ImageGeneration = NewImageGenerationClient(tx.config)
	tx.ImageProviderCredential = NewImageProviderCredentialClient(tx.config)
