...
var (
	...
	ImageAssetsColumns = []*schema.Column{
		...
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "user_id", Type: field.TypeInt64},
		{Name: "generation_id", Type: field.TypeInt64},
		{Name: "asset_type", Type: field.TypeEnum, Enums: []string{"input", "output", "thumbnail"}},
		{Name: "s3_bucket", Type: field.TypeString, Size: 255},
		{Name: "s3_key", Type: field.TypeString, Size: 1024},
	...
	ImageAssetsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "imageasset_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ImageAssetsColumns[4], ImageAssetsColumns[1]},
			},
			{
				Name:    "imageasset_generation_id_asset_type",
				Unique:  false,
				Columns: []*schema.Column{ImageAssetsColumns[5], ImageAssetsColumns[6]},
			},
			{
				Name:    "imageasset_s3_key",
				Unique:  false,
				Columns: []*schema.Column{ImageAssetsColumns[8]},
			},
			{
				Name:    "imageasset_sha256",
				Unique:  false,
				Columns: []*schema.Column{ImageAssetsColumns[13]},
			},
		},
	}
	...
	ImageConversationsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "imageconversation_user_id_last_message_at",
				Unique:  false,
				Columns: []*schema.Column{ImageConversationsColumns[4], ImageConversationsColumns[6]},
			},
			{
				Name:    "imageconversation_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ImageConversationsColumns[4], ImageConversationsColumns[1]},
			},
		},
	}
	...
	ImageGenerationsColumns = []*schema.Column{
		...
		{Name: "parent_generation_id", Type: field.TypeInt64, Nullable: true},
		{Name: "provider", Type: field.TypeString, Size: 32, Default: "agnes"},
		{Name: "provider_credential_id", Type: field.TypeInt64, Nullable: true},
		{Name: "model", Type: field.TypeString, Size: 128, Default: "agnes-image-2.1-flash"},
		{Name: "generation_type", Type: field.TypeEnum, Enums: []string{"text_to_image", "image_to_image"}},
		{Name: "prompt", Type: field.TypeString, Size: 2147483647},
		{Name: "size", Type: field.TypeString, Size: 16, Default: "2K"},
		{Name: "ratio", Type: field.TypeString, Size: 16, Default: "1:1"},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"pending", "queued", "processing", "succeeded", "failed", "canceled"}, Default: "pending"},
		{Name: "idempotency_key", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "provider_request_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "provider_original_url", Type: field.TypeString, Nullable: true, Size: 2048},
		{Name: "error_code", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
	...
	ImageGenerationsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "imagegeneration_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ImageGenerationsColumns[1], ImageGenerationsColumns[20]},
			},
			{
				Name:    "imagegeneration_conversation_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ImageGenerationsColumns[2], ImageGenerationsColumns[20]},
			},
			{
				Name:    "imagegeneration_status",
				Unique:  false,
				Columns: []*schema.Column{ImageGenerationsColumns[11]},
			},
			{
				Name:    "imagegeneration_parent_generation_id",
				Unique:  false,
				Columns: []*schema.Column{ImageGenerationsColumns[3]},
			},
			{
				Name:    "imagegeneration_user_id_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{ImageGenerationsColumns[1], ImageGenerationsColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "idempotency_key IS NOT NULL AND idempotency_key <> ''",
				},
			},
	...
	// ImageProviderCredentialsColumns holds the columns for the "image_provider_credentials" table.
	ImageProviderCredentialsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"agnes"}},
		{Name: "api_key_encrypted", Type: field.TypeString},
		{Name: "key_fingerprint", Type: field.TypeString, Size: 32},
		{Name: "enabled", Type: field.TypeBool, Default: true},
		{Name: "priority", Type: field.TypeInt, Default: 50},
		{Name: "weight", Type: field.TypeInt, Default: 1},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"healthy", "unhealthy", "disabled"}, Default: "healthy"},
		...
		{Name: "last_failure_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	// ImageProviderCredentialsTable holds the schema information for the "image_provider_credentials" table.
	ImageProviderCredentialsTable = &schema.Table{
		Name:       "image_provider_credentials",
		Columns:    ImageProviderCredentialsColumns,
		PrimaryKey: []*schema.Column{ImageProviderCredentialsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "imageprovidercredential_provider_enabled_status",
				Unique:  false,
				Columns: []*schema.Column{ImageProviderCredentialsColumns[2], ImageProviderCredentialsColumns[5], ImageProviderCredentialsColumns[8]},
			},
			{
				Name:    "imageprovidercredential_priority",
				Unique:  false,
				Columns: []*schema.Column{ImageProviderCredentialsColumns[6]},
			},
			{
				Name:    "imageprovidercredential_cooldown_until",
				Unique:  false,
				Columns: []*schema.Column{ImageProviderCredentialsColumns[13]},
			},
		},
	}
...
func init() {
	...
	ImageProviderCredentialsTable.Annotation = &entsql.Annotation{
