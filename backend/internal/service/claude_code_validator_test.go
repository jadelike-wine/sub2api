...
func TestCompareVersions(t *testing.T) {
	tests := []struct {
		...
		// 四段版本号支持：缺失段视为 0
		{"0.1.160", "0.1.160.1", -1}, // 三段 vs 四段，第 4 段 0 < 1
		{"0.1.160.1", "0.1.160", 1},  // 四段 vs 三段，第 4 段 1 > 0
		{"0.1.160.1", "0.1.160.1", 0}, // 四段相等
		{"0.1.161", "0.1.160.1", 1},   // 第 3 段 161 > 160，第 4 段不参与比较
		{"0.1.160.1", "0.1.161", -1},  // 第 3 段 160 < 161
		{"0.1.160.2", "0.1.160.1", 1}, // 第 4 段比较
		{"0.1.160.1", "0.1.160.2", -1},
		{"v0.1.160.1", "0.1.160.1", 0}, // v 前缀 + 四段
	}
	for _, tt := range tests {
