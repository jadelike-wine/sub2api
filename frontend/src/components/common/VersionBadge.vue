...
const GITHUB_REPO = 'jadelike-wine/sub2api'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/jadelike-wine/sub2api:0.1.160)
const DOCKER_IMAGE = 'ghcr.io/jadelike-wine/sub2api'
